...
?>
<?php 
	$json1 = file_get_contents('https://api.thingspeak.com/channels/254858/fields/1.json');
...
?>
<?php 
	$json2 = file_get_contents('https://api.thingspeak.com/channels/254858/fields/2.json');
...
?>
<?php 
	$json3 = file_get_contents('https://api.thingspeak.com/channels/254858/fields/3.json');
...
<?php 
	$json4 = file_get_contents('https://api.thingspeak.com/channels/254858/fields/4.json');
...
?>
<?php 
	$json5 = file_get_contents('https://api.thingspeak.com/channels/254858/fields/5.json');
	...
	<head>
		...
		<script type="text/javascript">
			...
			function load1_on()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field1=ON',
                data: {},
                dataType: 'json',
			...
			function load1_off()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field1=OFF',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
            ...
            function load2_on()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field2=ON',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
			...
			function load2_off()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field2=OFF',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
            ...
            function load3_on()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field3=ON',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
			...
			function load3_off()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field3=OFF',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
            ...
            function load4_on()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field4=ON',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
			...
			function load4_off()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field4=OFF',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
            ...
            function load5_on()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field5=ON',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
			...
			function load5_off()
            {
                ...
                $.ajax({
                type: 'POST',
                url: 'https://api.thingspeak.com/update?api_key=W1XO3JQORH3IREV0&field5=OFF',
                data: {},
                dataType: 'json',
                success: function(data) 
                { 
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      ...
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <li class="active"><a href="room3.php">Room 3</a></li>
