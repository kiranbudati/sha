...
?>
<?php 
	$json1 = file_get_contents('https://api.thingspeak.com/channels/254852/fields/1.json');
...
?>
<?php 
	$json2 = file_get_contents('https://api.thingspeak.com/channels/254852/fields/2.json');
...
?>
<?php 
	$json3 = file_get_contents('https://api.thingspeak.com/channels/254852/fields/3.json');
...
<?php 
	$json4 = file_get_contents('https://api.thingspeak.com/channels/254852/fields/4.json');
...
?>
<?php 
	$json5 = file_get_contents('https://api.thingspeak.com/channels/254852/fields/5.json');
